const demographic_form = {
    ...
    html: '<div style="max-width:980px; text-align:center;"><p>' +
        ...
        '"Woman" /> <label for="woman"> Woman </label>' +
        '<input name="gender" type="radio" id="man" value=' +
        '"Man" /> <label for="man"> Man </label>' +
